 ...
 * @endcode
 */
$settings['hash_salt'] = 'gi2dZk_ti5aFznzY1-euIku21GMRZr75ap1duaGVn9Vqzwoyr_aWQP-seqUavCPITqHr0nbamQ';
...
else if (file_exists($app_root . '/' . $site_path . '/settings.docksal.php')) {
